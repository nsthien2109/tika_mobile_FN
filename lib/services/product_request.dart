...
class ProductService {
  ...
  static Future<ProductModel?> getProductOfCategory(page, idCategory) async {
    final response = await http.get(Uri.parse('$domain/products_category/$idCategory?page=$page'));
    if (response.statusCode == 200) {
      final productResponse = json.decode(response.body);
      final productData = productResponse['data']['data'] as List<dynamic>;
      final List<DataProduct> products = [];
